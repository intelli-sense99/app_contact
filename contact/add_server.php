...
$url = 'http://localhost/workspace/app_contact/contact/add.php';
...
if (count($error) == 0) {
    ...
    $query = "INSERT INTO $table_name (`name`,`phone`,`email`,`image`,`address`,`author_id`) VALUES ('$name','$phone','$email','$image','$address',$auther_id)";
    $result = mysqli_query($connection, $query);
